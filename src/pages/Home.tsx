export const Home = () => {
  return (
    <>
      <div className="mx-auto mb-[40px] h-[213px] w-[213px] overflow-hidden rounded-full bg-gradient-to-tr from-[#FF8660] to-[#8000FF]">
        <img src="/Ruairidh.jpg" alt="Ruairidh Profile" />
      </div>
